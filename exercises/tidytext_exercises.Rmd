...
### Chapter 4. Part 4: Relationships between words: n-grams and correlations
...
# Exercise 11b.When we count our bigrams using dlpyr’s count(), we see that a lot of the most common bigrams are pairs of common words, like stop words. Run this code and you’ll see…
...
##X Part 5: Counting and correlating pairs of words
